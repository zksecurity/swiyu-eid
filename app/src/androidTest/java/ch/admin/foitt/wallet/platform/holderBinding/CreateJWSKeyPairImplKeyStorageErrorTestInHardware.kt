...
class CreateJWSKeyPairImplKeyStorageErrorTestInHardware(
    ...
    companion object {
        ...
        fun data(): List<Array<Any>> {
            return listOf(
                ...
                arrayOf(listOf(KeyStorageSecurityLevel.MODERATE), true),
                arrayOf(listOf(KeyStorageSecurityLevel.MODERATE), false),
                arrayOf(listOf(KeyStorageSecurityLevel.BASIC), true),
                arrayOf(listOf(KeyStorageSecurityLevel.BASIC), false),
            )
        }
    }
}
